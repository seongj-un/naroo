...
object RecoveryMissionExceptionMapper {
    fun toResponseEntity(ex: RecoveryMissionException): ResponseEntity<Any> =
        when (ex) {
            ...
            is RecoveryMissionException.RecoveryMissionSeriesCompleted ->
                ResponseEntity.status(HttpStatus.CONFLICT).body(RecoveryMissionErrorCode.RECOVERY_MISSION_SERIES_COMPLETED.toWrappedDto())
